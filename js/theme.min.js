...
! function() {
    ...
    null != (r = document.querySelector(".navbar-sticky")) && (r.classList, t = r.offsetHeight, window.addEventListener("scroll", function(e) { 500 < e.currentTarget.pageYOffset ? (document.body.style.paddingTop = t + "px", r.classList.add("navbar-stuck")) : (document.body.style.paddingTop = "", r.classList.remove("navbar-stuck")) })), e = document.querySelector(".navbar-stuck-toggler"), a = document.querySelector(".navbar-stuck-menu"), null != e && e.addEventListener("click", function(e) { a.classList.toggle("show"), e.preventDefault() }),
        ...
        }, !1), new SmoothScroll("[data-scroll]", { speed: 800, speedAsDuration: !0, offset: 40, header: "[data-scroll-header]", updateURL: !1 }),
        function() {
            ...
            for (var s = function() {
                    ...
                    if (l.classList.remove("show"), setTimeout(function() { a.removeChild(l) }, 50), o && (a.style.paddingRight = 0, n.length))
                ...
                e.preventDefault(),
                    function(e) {
                        if (a.appendChild(l), setTimeout(function() { l.classList.add("show") }, 20), document.querySelector(e).classList.add("show"), o && (a.style.paddingRight = "15px", n.length))
            ...
            for (var i = 0; i < t.length; i++) t[i].addEventListener("click", function(e) { e.preventDefault(), s() });
            document.addEventListener("click", function(e) { "offcanvas-backdrop" === e.target.classList[0] && s() })
        }(), null != (o = document.querySelector(".btn-scroll-top")) && (n = parseInt(600, 10), window.addEventListener("scroll", function(e) { e.currentTarget.pageYOffset > n ? o.classList.add("show") : o.classList.remove("show") })), [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]')).map(function(e) { return new bootstrap.Tooltip(e, { trigger: "hover" }) }), [].slice.call(document.querySelectorAll('[data-bs-toggle="popover"]')).map(function(e) { return new bootstrap.Popover(e) }), [].slice.call(document.querySelectorAll(".toast")).map(function(e) { return new bootstrap.Toast(e) }),
        ...
        function(e, t, r) { for (var a = 0; a < e.length; a++) t.call(r, a, e[a]) }(document.querySelectorAll(".tns-carousel .tns-carousel-inner"), function(e, t) {
        ...
        function() {
            for (var n = document.querySelectorAll(".range-slider"), e = 0; e < n.length; e++) ! function(e) {
                ...
                noUiSlider.create(t, { start: [e.dataStartMin, e.dataStartMax], connect: !0, step: e.dataStep, pips: { mode: "count", values: 5 }, tooltips: !0, range: { min: e.dataMin, max: e.dataMax }, format: { to: function(e) { return "Rs " + parseInt(e, 10) }, from: function(e) { return Number(e) } } }), t.noUiSlider.on("update", function(e, t) {
                    e = (e = e[t]).replace(/\D/g, "");
        ...
        function() {
            for (var n = document.querySelectorAll(".range-slider-2"), e = 0; e < n.length; e++) ! function(e) {
                var t = n[e].querySelector(".range-slider-ui"),
                    r = n[e].querySelector(".range-slider-value-min"),
                    a = n[e].querySelector(".range-slider-value-max"),
                    e = { dataStartMin: parseInt(n[e].dataset.startMin, 10), dataStartMax: parseInt(n[e].dataset.startMax, 10), dataMin: parseInt(n[e].dataset.min, 10), dataMax: parseInt(n[e].dataset.max, 10), dataStep: parseInt(n[e].dataset.step, 10) };
                noUiSlider.create(t, { start: [e.dataStartMin, e.dataStartMax], connect: !0, step: e.dataStep, pips: { mode: "count", values: 5 }, tooltips: !0, range: { min: e.dataMin, max: e.dataMax }, format: { to: function(e) { return "<i class='ci-star-filled'></i> " + parseInt(e, 10) }, from: function(e) { return Number(e) } } }), t.noUiSlider.on("update", function(e, t) {
                    e = (e = e[t]).replace(/\D/g, "");
                    t ? a.value = Math.round(e) : r.value = Math.round(e)
                }), r.addEventListener("change", function() { t.noUiSlider.set([this.value, null]) }), a.addEventListener("change", function() { t.noUiSlider.set([null, this.value]) })
            }(e)
